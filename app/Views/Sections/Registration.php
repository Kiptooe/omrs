...
<form id='form-register' action="/registration/registration" method="post">
...
<div id=""class="row col col-lg-5">
  ...
  <div class="col col-md-12 form-group">
    ...
    <select class="form-control" name="role_name" id="role_name" onblur ="validate_select(this.value, 'role_error');">
...
<div id="1"class="row col col-lg-5">
  <div class="col col-md-12 form-group">
...
<div id="2"class="row col col-lg-5">
  <div class="col col-md-12 form-group">
...
<div id="2"class="row col col-lg-5" style="display:none">
  <div class="col col-md-12 form-group">
