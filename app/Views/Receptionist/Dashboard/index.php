...
?>
      <div class="container">
        ...
        <div class="row">
            ...
            createSection2('calendar', '/home/role_pages/'.$_SESSION['code'].'?nv='.$_SESSION['code'], 'New Visit');
            createSection2('book', '/home/role_pages/'.$_SESSION['code'].'?pr='.$_SESSION['code'], 'Patient Report');
